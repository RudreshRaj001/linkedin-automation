      ...
      <div className="max-w-4xl mx-auto mb-8 sm:mb-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 text-sm sm:text-base max-w-2xl mx-auto">
            Manage your professional presence with powerful publishing and profile tools
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="group relative order-1 lg:order-1">
            ...
            <div className="relative bg-gray-900/90 backdrop-blur-xl rounded-2xl p-6 sm:p-8 shadow-2xl border border-gray-800/50 h-full">
          ...
          {/* Profile Info Card */}
          <div className="group relative order-2 lg:order-2">
